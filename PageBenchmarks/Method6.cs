...
{
    private DataPage PageMethod6(string search, int page, int pageSize)
    {
        ...
        command.CommandText = "create index on _temp_customers using btree (row)";
        command.ExecuteNonQuery();
    ...
    public void Method6()
    {
        var result = PageMethod6("john", 625, 10);
    }
}
